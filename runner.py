...
configs = [
    ("BCHXBT_15min_Kraken.csv", {
        ...
        'pair_points': 300,
        'rsi_period_min': 5, 'rsi_period_max': 30,
        'rsi_threshold_min': 20, 'rsi_threshold_max': 80,
        'ema_short_period_min': 5, 'ema_short_period_max': 20,
        'ema_long_period_min': 21, 'ema_long_period_max': 50,
        'stoch_k_period_min': 5, 'stoch_k_period_max': 21,
        'stoch_d_period_min': 3, 'stoch_d_period_max': 8,
        'stoch_slowing_min': 3, 'stoch_slowing_max': 8,
        'obv_ema_period_min': 5, 'obv_ema_period_max': 20,
