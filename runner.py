...
configs = [
    ("ETHXBT_15min_Kraken.csv", {
        ...
        'ideal_trade_frequency_hours_max': (24*3),
        'init_points': 8000, 'iter_points': 0,
        'macd_fast_min': 5, 'macd_fast_max': 30,
        'macd_slow_min': 12, 'macd_slow_max': 50,
        'macd_signal_min': 2, 'macd_signal_max': 25,
        'macd_persist_min': 1, 'macd_persist_max': 10,
        'bb_p_min': 5, 'bb_p_max': 35,
        'bb_dev_low_min': 1.0, 'bb_dev_low_max': 3.0,
        'bb_dev_up_min': 1.0, 'bb_dev_up_max': 3.0,
        'rsi_period_min': 3, 'rsi_period_max': 30,
        'rsi_threshold_buy_min': 10, 'rsi_threshold_buy_max': 60,
        'rsi_threshold_sell_min': 40, 'rsi_threshold_sell_max': 90,
        'obv_p_min': 2, 'obv_p_max': 30,
        'obv_persist_min': 1, 'obv_persist_max': 10,
        'stop_loss_pct_min': 1.5, 'stop_loss_pct_max': 2.0
    }),
    ...
    ("LTCXBT_15min_Kraken.csv", {
        ...
        'ideal_trade_frequency_hours_max': (24*3),
        'init_points': 8000, 'iter_points': 0,
        'macd_fast_min': 3, 'macd_fast_max': 30,
        'macd_slow_min': 12, 'macd_slow_max': 50,
        'macd_signal_min': 2, 'macd_signal_max': 30,
        'macd_persist_min': 1, 'macd_persist_max': 10,
        'bb_p_min': 3, 'bb_p_max': 40,
        'bb_dev_low_min': 0.25, 'bb_dev_low_max': 3.0,
        'bb_dev_up_min': 0.25, 'bb_dev_up_max': 3.0,
        'rsi_period_min': 3, 'rsi_period_max': 30,
        'rsi_threshold_buy_min': 10, 'rsi_threshold_buy_max': 60,
        'rsi_threshold_sell_min': 40, 'rsi_threshold_sell_max': 90,
        'obv_p_min': 2, 'obv_p_max': 30,
        'obv_persist_min': 1, 'obv_persist_max': 10,
        'stop_loss_pct_min': 1.0, 'stop_loss_pct_max': 2.0
    }),
    ...
    #     'init_points': 300, 'iter_points': 2000,
