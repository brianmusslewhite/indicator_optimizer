...
configs = [
    ("ETHXBT_15min_Kraken.csv", {
        ...
        'macd_slow_min': 12, 'macd_slow_max': 26,
        'macd_signal_min': 2, 'macd_signal_max': 9,
        'macd_persist_min': 1, 'macd_persist_max': 5,
        'bb_p_min': 5, 'bb_p_max': 20,
        'bb_dev_low_min': 0.5, 'bb_dev_low_max': 2.0,
        'bb_dev_up_min': 0.5, 'bb_dev_up_max': 2.0,
        'rsi_period_min': 5, 'rsi_period_max': 14,
        'rsi_threshold_buy_min': 20, 'rsi_threshold_buy_max': 50,
        'rsi_threshold_sell_min': 50, 'rsi_threshold_sell_max': 80,
        'obv_p_min': 2, 'obv_p_max': 10,
